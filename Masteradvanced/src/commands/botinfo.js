exports.run = async(client, message) => {
    ...
    const uptime = moment.duration(client.uptime).format(' D [days], H [hrs], m [mins], s [secs]');
                  ...
                  var lol = Math.floor(Math.random() * 98 + 1);
const m = await message.channel.send("<a:tickg:473984512708050945> Generated withing 2 seconds!");
    ...
    var embed = new RichEmbed()
        ...
        .addField('** Bot Uptime**', uptime, true)
            ...
            .addField('**Bot Status**', `<a:green:473603173592858634> Online`, true)
                .addField('**Bot Ping|MS**', `${m.createdTimestamp - message.createdTimestamp}ms`, true)
			.addField('**Memory Usage**', `${Math.round(process.memoryUsage().heapUsed / 1024 / 1024)}MB`, true)
            .addField('**Bot Language**', `Javascript , discord.js `, true)
            .addField("**CPU usage**", `\`${amount}.${lol}%\``, true)
